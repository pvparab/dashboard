...
if(isset($_POST['submit']))
{
   ...
   // $gallery_status = $_POST['is_gallery'];
    ...
    if(empty($_GET['update_id']))
    {
        if($gallery_status == 1)
        {
            $query1 = "insert into gallery_master(`gallery_id`, `gallery_name`, `is_active`, `is_rar_file`, `gallery_desc`, `createdOn`, `is_delete`) values('','".$gallery_name."',".$is_active.",".$rar_status.",'".$gall_desc."','".$current_date."',0)";
            $con->query($query1);
    ...
    {
         $query21 = "update gallery_master set gallery_name = '".$gallery_name."', is_active = ".$is_active.", gallery_desc = '".$gall_desc."', is_rar_file = ".$rar_status." where gallery_id = ".$_POST['gall_id']."";
         $con->query($query21);
    ...
    if(!empty($_GET['update_id']) && $rar_status == 0)
    {
    ...
    else
    {
        if($rar_status == 2)
        {
            ...
            foreach($_FILES['files']['tmp_name'] as $key => $tmp_name ){
                    ...
                    $query2="insert into gallery_image_master(`image_id`,`image_name`,`image_title`,`img_type`,`gallery_id`,`is_delete`,`createdOn`) VALUES('','".$file_name."','".$_POST['title'][$key]."','".$file_type."','".$gal_id."',0,'".$current_date."')";
...
{    $fetch_child_record = array();
   ...
   // echo "<pre>";print_r($fetch_master_record);
    ...
    $query121 = "select * from gallery_image_master where gallery_id =".$_GET['update_id']." and is_delete = 0";
                ...
                <div class="row">
                    ...
                    <?php if(empty($_GET['update_id'])) {?>
                        <div class="container" style="padding-left: :15px;"> 
                            ...
                            <div class="form-group">
                                <div class="control-group" id="fields" style="">
                                        <label class="control-label" for="field1">Upload Multiple Images</label><br />
                                        <label class="control-label" for="field1">(If you want to upload images from different folder please click on ( + ) button)</label>
                                        <div class="controls"> 
                                            <div class="multiple">
                        ...
                        <?php }else{?>
                           ...
                           <!-- <div class="form-group" style="width:25%;">
                            ...
                            <?php if(!empty($fetch_child_record)) {?>
                            <div class="form-group">
                                             ...
                                             <table  id="tbl_img" style="">
                                                     ...
                                                     <?php for($i = 0;$i<=$child_img_count-1;$i++){?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $fetch_child_record[$i]['image_title']; ?></td>
                                                            <td><?php echo $fetch_child_record[$i]['image_name']; ?></td>
                                                            <td><?php echo $fetch_child_record[$i]['img_type']; ?></td>
                                                         </tr>
                                                     <?php } ?>
                                                     </tbody>
                                             </table>
